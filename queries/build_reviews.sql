...
/*monthly breakdown -- number of cleanups per month*/
...
,[13] as [13] --excluded from average
FROM (SELECT project_id,months_ago,reported_by from #brs) p
PIVOT (
COUNT(project_id)
FOR
months_ago
