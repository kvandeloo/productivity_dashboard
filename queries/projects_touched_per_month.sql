...
DROP TABLE IF EXISTS #worked_on_projects_each_month;
...
/*monthly breakdown - number of projects touched each month*/
...
FROM (SELECT project_id,months_ago,reported_by from #worked_on_projects_each_month) p
PIVOT (
COUNT(project_id)
FOR
months_ago
